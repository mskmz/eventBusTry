package com.mskmz.eventbusannotationprocess.utils;
...
public class Constants {
  ...
  // 注解处理器中支持的注解类型
  public static final String SUBSCRIBE_ANNOTATION_TYPES = "com.mskmz.eventbusannotation.Subscribe";
  ...
  // 所有的事件订阅方法，生成索引接口
  public static final String SUBSCRIBERINFO_INDEX = "com.mskmz.eventbus.annotation.SubscriberInfoIndex";
